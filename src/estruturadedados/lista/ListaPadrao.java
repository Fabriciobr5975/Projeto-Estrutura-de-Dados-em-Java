...
import estruturadedados.metodosdebusca.BuscaBinaria;
import estruturadedados.util.RemocoesAvancadas;
 ...
 */
public interface ListaPadrao<T extends Comparable<T>> extends BuscaBinaria<T>, RemocoesAvancadas {
     ...
     * tenha as posição, mas não tenha elementos
     */
    T removerDoFim() throws NullPointerException, RuntimeException;
     ...
     * tenha as posição, mas não tenha elementos
     */
    T remover(int posicao) throws ArrayIndexOutOfBoundsException, NullPointerException, RuntimeException;
     ...
     * remoção
     */
    T removerElemento(T elemento) throws RuntimeException, NullPointerException;
     ...
     * usuário não corresponda a uma posição válida dentro da lista.
     */
    T buscarPorPosicao(int posicao) throws RuntimeException, ArrayIndexOutOfBoundsException;
     ...
     */
    int buscar(T elemento) throws RuntimeException;
     ...
     * tenha as posição, mas não tenha elementos
     */
    T buscarNoInicio() throws RuntimeException;
     ...
     * tenha as posição, mas não tenha elementos
     */
    T buscarUltimoElemento() throws RuntimeException;
     ...
     * tenha as posição, mas não tenha elementos
     */
    int buscarPosicaoUltimoElemento() throws RuntimeException;
    ...
    /**
     * Método que tranforma a lista em um Stream para possibilitar a utilização
     * da mesma
     *
     * @return Retorna uma Stream da lista
     */
    public Stream<T> stream();

    /**
     * Método que tranforma a lista em um Stream com paralelismo para
     * possibilitar a utilização da mesma
     *
     * @return Retorna uma Stream da lista
     */
